...
const FAQ_DATA = [
    { q: "[계정/로그인/패스워드] Q. 아이디를 분실 했을 떄 어떻게 해야하나요?", a: "A. 아래 내용을 고객센터로 전달하여, 확인을 요청해주십시오.<br><br>- 이메일 : <br>- 대표예약자명 :<br>- 예약번호" },
    { q: "[계정/로그인/패스워드] Q. 패스워드를 분실했을 떄 어떻게 해야하나요?", a: "A. 예약 조회 하단의 [비밀번호 찾기] 기능을 이용하시면, 임시 비밀번호가 대표예약자의 이메일로 발송됩니다.<br>아이디에 기재한 이메일이 아닌 대표예약자 란에 기재한 이메일로 발송되오니 유의바랍니다." },,
